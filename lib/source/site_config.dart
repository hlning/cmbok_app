...
class SiteConfig {
  ...
  factory SiteConfig.fromJson(Map<String, dynamic> j) => SiteConfig(
    ...
    chapterFallbackLinkDom:
        (j['chapter_fallback_link_dom'] as String?) ?? '',
  ...
  Map<String, dynamic> toJson() => {
    ...
    'categories': categoryGroups != null
        ? categoryGroups!.map((k, v) => MapEntry(
              k,
              v
                  .map((e) =>
                      {'value': e.value, 'name': e.name, 'isAll': e.isAll})
                  .toList(),
            ))
        : categories
